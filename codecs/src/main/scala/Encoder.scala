...
object Encoder {
  ...
  implicit def tuple2Encoder[A: Encoder, B: Encoder]: Encoder[Tuple2[A, B]] = from { tup =>
    Json.Object(Map("1" -> tup._1.asJson, "2" -> tup._2.asJson))
  }

  implicit def tuple3Encoder[A: Encoder, B: Encoder, C: Encoder]: Encoder[Tuple3[A, B, C]] = from { tup =>
    Json.Object(Map("1" -> tup._1.asJson, "2" -> tup._2.asJson, "3" -> tup._3.asJson))
  }
